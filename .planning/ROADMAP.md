...
Plans:
- [ ] 21.1-01-PLAN.md — SdetConfig Pydantic sub-model + Config.sdet required field + example YAMLs (RELOC-01) [wave 1; depends_on: ]
- [ ] 21.1-02-PLAN.md — gen-sdet-classes + mcp_session consume cfg.sdet.generated_root via spec_from_file_location; _tool_factory docstring + pyright pruning (RELOC-02) [wave 2; depends_on: 21.1-01]
...
| 21.1. SDET generated output relocation | v1.3 | 0/4 | Not started | — |
