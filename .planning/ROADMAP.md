...
- [ ] **Phase 1: Foundation & Pure-Data Core** - Bootstrap project, lock pytest-asyncio config, ban black-box imports, build config loader and schema validator
...
|-------|----------------|--------|-----------|
| 1. Foundation & Pure-Data Core | 0/TBD | Not started | - |
