...
Plans:
- [ ] 31-01-PLAN.md - SHIM-04: Remove sdet: alias machinery + add operator-tone rejection branch
- [ ] 31-02-PLAN.md - SHIM-05: Unwire MCPTF_CONFIG_FILE + D-06 plugin warning + D-08 formatwarning visibility upgrade
...
| 31. Config-surface cleanup — drop MCPTF_CONFIG_FILE + cfg.sdet.* alias + v1-schema decommission | v1.5 | 1/6 | In Progress|  |
